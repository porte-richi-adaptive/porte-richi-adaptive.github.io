...
!function webpackUniversalModuleDefinition(root, factory) {
  ...
  return modules = [function (module) {
    ...
    var _mask = __webpack_require__(15),
        _maskLexer = __webpack_require__(16),
    ...
    Inputmask.prototype = {
      ...
      getmetadata: function getmetadata() {
        if (this.maskset = this.maskset || (0, _maskLexer.generateMaskSet)(this.opts, this.noMasksCache), $.isArray(this.maskset.metadata)) {
    ...
    function caret(input, begin, end, notranslate, isDelete) {
      ...
      if ($.isArray(begin) && (end = this.isRTL ? begin[0] : begin[1], begin = this.isRTL ? begin[1] : begin[0]), void 0 !== begin.begin && (end = this.isRTL ? begin.begin : begin.end, begin = this.isRTL ? begin.end : begin.begin), "number" == typeof begin) {
    ...
    function getTests(pos, ndxIntlzr, tstPs) {
      ...
      function mergeLocators(pos, tests) {
        var locator = [];
        return $.isArray(tests) || (tests = [tests]), 0 < tests.length && (void 0 === tests[0].alternation || !0 === opts.keepStatic ? (locator = determineTestTemplate.call(inputmask, pos, tests.slice()).locator.slice(), 0 === locator.length && (locator = tests[0].locator.slice())) : $.each(tests, function (ndx, tst) {
    ...
    function checkAlternationMatch(altArr1, altArr2, na) {
      for (var opts = this.opts, $ = this.dependencyLib, altArrC = opts.greedy ? altArr2 : altArr2.slice(0, 1), isMatch = !1, naArr = void 0 !== na ? na.split(",") : [], naNdx, i = 0; i < naArr.length; i++) {
    ...
    function isValid(pos, c, strict, fromIsValid, fromAlternate, validateOnly, fromCheckval) {
      ...
      if ($.isFunction(opts.preValidation) && !0 !== fromIsValid && !0 !== validateOnly && (result = opts.preValidation.call(el, _positioning.getBuffer.call(inputmask), maskPos, c, isSelection(pos), opts, maskset, pos, strict || fromAlternate), result = processCommandObject(result)), !0 === result) {
          ...
          if (result = _isValid(maskPos, c, strict), (!strict || !0 === fromIsValid) && !1 === result && !0 !== validateOnly) {
            ...
            if (!currentPosValid || !0 !== currentPosValid.match.static || currentPosValid.match.def !== c && c !== opts.skipOptionalPartCharacter) {
              if (opts.insertMode || void 0 === maskset.validPositions[_positioning.seekNext.call(inputmask, maskPos)] || pos.end > maskPos) {
                var skip = !1;
                if (maskset.jitOffset[maskPos] && void 0 === maskset.validPositions[_positioning.seekNext.call(inputmask, maskPos)] && (result = isValid.call(inputmask, maskPos + maskset.jitOffset[maskPos], c, !0), !1 !== result && (!0 !== fromAlternate && (result.caret = maskPos), skip = !0)), pos.end > maskPos && (maskset.validPositions[maskPos] = void 0), !skip && !_positioning.isMask.call(inputmask, maskPos, opts.keepStatic)) for (var nPos = maskPos + 1, snPos = _positioning.seekNext.call(inputmask, maskPos); nPos <= snPos; nPos++) {
    ...
    function unmaskedvalue(input) {
      ...
      for (var pndx in vps) {
        vps[pndx] && vps[pndx].match && (1 != vps[pndx].match.static || $.isArray(maskset.metadata) && !0 !== vps[pndx].generatedInput) && umValue.push(vps[pndx].input);
      }
    ...
    var EventRuler = {
      ...
      off: function off(input, event) {
        if (input.inputmask && input.inputmask.events) {
          var _$ = input.inputmask.dependencyLib,
    ...
    __webpack_require__(14), __webpack_require__(17), __webpack_require__(18), __webpack_require__(19), module.exports = __webpack_require__(1);
  }, function (module, exports, __webpack_require__) {
    "use strict";
    ...
    var Inputmask = __webpack_require__(1),
        ...
        escapeRegex = __webpack_require__(12).default,
        formatCode = {
